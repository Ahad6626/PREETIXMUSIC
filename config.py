...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/Ahad6626/PREETIXMUSIC")
...
PING_IMG_URL = os.getenv("PING_IMG_URL", "https://files.catbox.moe/p3s1jd.jpg")
PLAYLIST_IMG_URL = "https://files.catbox.moe/ydvqvu.jpg"
